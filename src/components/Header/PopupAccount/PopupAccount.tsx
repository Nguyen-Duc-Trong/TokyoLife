...
const PopupAccount = () => {
    ...
    return(
        <div id="PopupAccount" className="w-[340px] top-[0px] md:max-xl:right-[-86px] -[-0px] right-[-165px] bg-[#ffffff]">
            <div className="p-[20px]">
                <div className="pb-[10px]">
                    <p className="flex justify-center items-center text-[18px] text-[#000000] font-medium">ĐĂNG NHẬP TÀI KHOẢN</p>
                    <p className="flex justify-center items-center text-[14px] text-[#677279]">Nhập email và mật khẩu của bạn</p>
                </div>
                <div className="pt-[20px] border-t border-solid border-[#e7e7e7]">
                    ...
                    >
                        ...
                        <Form.Item className="mb-[0px]" wrapperCol={{ offset: 0, span: 160}}>
                          <Button type="primary" htmlType="submit" className="bg-[#3b5998] button3 w-[300px] font-medium py-[0px] flex justify-center items-center h-[42px] text-[14px] rounded-[5px]">
                            <span className="w-[40px] h-[40px]">
